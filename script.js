          ...
          <div class="parsed-item" style="display: flex; justify-content: space-between; align-items: center; width: 100%;">
            ...
            <div style="display: flex; align-items: center; gap: 6px;">
              ...
              <div style="display: flex; align-items: center; gap: 4px;">
                <button class="star-unfollowed-btn" data-username="${user.username}" aria-label="star user" title="move to starred list">
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                    <polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"></polygon>
                  </svg>
                </button>
                <button class="remove-unfollowed-btn" data-username="${user.username}" aria-label="remove from unfollowed" title="remove from history">
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
  ...
  if (listData.length > 0) {
    ...
    listEl.innerHTML = listData.map(user => `
      <div class="parsed-item" style="display: flex; justify-content: space-between; align-items: center; width: 100%;">
        ...
        <div style="display: flex; align-items: center; gap: 6px;">
          <span>${user.fullName ? user.fullName : ''}</span>
          <button class="unstar-btn" data-username="${user.username}" aria-label="unstar user" title="unstar user">
